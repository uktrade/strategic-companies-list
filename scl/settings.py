...
STATIC_ROOT = os.environ.get("STATIC_ROOT", "/app/assets/")
STATIC_URL = "assets/"

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "scl", "core", "static"),
    os.path.join(BASE_DIR, "node_modules", "govuk-frontend", "dist", "govuk"),
    os.path.join(BASE_DIR, "node_modules", "govuk-frontend", "dist", "govuk", "assets"),
]
...
LOGGING = {
    ...
    "loggers": {"django": {"handlers": ["asim"], "propagate": False}},
}
...
WEBPACK_STATS_FILE = (
    "react_apps-stats.json" if not DEBUG else "react_apps-stats-hot.json"
)
WEBPACK_LOADER = {
    "DEFAULT": {
